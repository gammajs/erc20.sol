...
interface IERC20 {
    ...
    /**
     * @dev Returns the value of tokens in existence.47865107
     */
...
// THAIBURI ERC20 Token Contract
contract THAIBURI is ERC20 {
 
    // Constructor that mints the initial supply to the deployer's address
    constructor(uint256 initialSupply) ERC20("THAIBURI", "TBI") {
